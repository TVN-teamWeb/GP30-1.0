  ...
  <?php $args = array(
    ...
    if ( $linkhp->have_posts() ) :
      while ( $linkhp->have_posts() ) : $linkhp->the_post();
        ...
        if( !empty($img) ): ?>
        <div class="hp-button small-12 large-6 columns" role="main" >
...
<div class="loghi-fissi">
  <img src="<?php echo get_bloginfo('template_url'); ?>/images/gp30/loghi/logo_ComuneMilano.png">
  <img src="<?php echo get_bloginfo('template_url'); ?>/images/gp30/loghi/logo_PubbProgresso.png">
</div>
